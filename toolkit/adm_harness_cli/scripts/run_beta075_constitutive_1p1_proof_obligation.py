...
from adm_harness.beta075_constitutive_1p1_proof_obligation import (  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the beta075 full 1+1 constitutive source-coupled proof-obligation certificate."
    )
    ...
    parser.add_argument("--jitter-radius-steps", type=int, default=8)
...
def main() -> int:
    ...
    spec = Constitutive1p1ProofSpec(
        ...
        jitter_radius_steps=int(args.jitter_radius_steps),
    ...
    files = write_constitutive_1p1_proof_outputs(args.outdir, outputs, metadata)
    print(json.dumps({
        "ok": True,
