...
\begin{enumerate}
\item the \href{supporting_reports/RAIL_COMPONENT_CROSS_REFERENCE_AND_JOINT_COORDINATION.md}{component cross-reference and joint-coordination specification}, \href{supporting_reports/COUPLED_SOURCE_ROLE_AUDIT.md}{source-role allocation audit}, and \href{supporting_reports/LE_CLASSIFIER_REPAIR.md}{corrected classifier evidence}, with their registered construction backgrounds;
