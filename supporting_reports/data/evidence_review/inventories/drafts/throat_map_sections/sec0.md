...
`toolkit/adm_harness_cli/`. Line numbers are `cat -n` lines at the repository
state of 2026-09-26. Every entry is marked as an **identity** holding for a class
...
| **L7** | **Architecture superseded** by the one-space axial track (`THROAT_GEOMETRY_CLARIFICATION.md:184-250`). | All design-specific magnitudes. Identities (section 7) survive. |
